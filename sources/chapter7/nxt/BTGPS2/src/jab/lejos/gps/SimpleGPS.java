...
//import jab.lejos.gps.aux.NoSuchElementException;
//import jab.lejos.gps.aux.StringTokenizer;
...
public class SimpleGPS extends Thread {
	 ...
	 * @return NMEA string, including $ and end checksum 
	 */
	private String getNextStringOld() {
		boolean done = false;
		String sentence = "";
		int endIndex = 0;
		...
		do{
			...
			try {
				...
				System.out.println("getNextString: IO Exception");
				// How to handle error?
			}catch(Exception e){
				// ??
				System.out.println("getNextString: Exception");
			}
